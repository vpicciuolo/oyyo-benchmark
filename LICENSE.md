...
This repository is publicly visible for technical transparency, reproducible evaluation and documentation. Public visibility does not grant a license to use, copy, modify, distribute, sublicense or create derivative works from OYYO proprietary material, except for rights that may be provided by applicable law or GitHub's Terms of Service.

If a specific file or artifact is released under different terms, those terms must be stated explicitly for that file or artifact. No broader OYYO license should be inferred from this repository being public.
